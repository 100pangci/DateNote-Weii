...
object AiSystemPrompt {
    fun build(now: LocalDateTime = LocalDateTime.now(), defaultReminderMinutes: Int): String = """
        ...
        输出格式：
        {"items":[{"title":"string","date":"yyyy-MM-dd","time":"HH:mm or null","category":"string or null","note":"string","remindBeforeMinutes":null,"confidence":0.0,"uncertainties":[]}],"warnings":[]}
    """.trimIndent()
}
